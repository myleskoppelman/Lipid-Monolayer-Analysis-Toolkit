...
def main():
    ...
    max_area_variation = 0.9 # Decimal percentage only (0-whatever)
    ...
    max_areachange = 0.9 # Decimal percentage only (0-1)
    max_movement = 50
    max_frameskip = 0
    ...
    max_areachange2 = 0.9 # Percentages only
    max_movement2 = 20
    max_frameskip2 = 0
    # -------------------------------------------------------------------------
    ...
    adaptive_thresh, threshold_factor, slices, xlsx_save_path, tagged_tif_path) = getOptions(s1,s2,s3)
    
    
    
    data, tif_path = preProcess(file_path, binary, domain_color, border, max_eccentricity, min_area, adaptive_thresh, threshold_factor, slices)
