...
''' [trackAndTagComplete.py] Last Updated: 7/11/2025 by Myles Koppelman
...
def getOptions(s1, s2, s3): 
    '''
    [getOptions.py] Last Updated: 7/14/2025 Myles Koppelman
...
def main():
    ...
    min_frames = 3
    max_eccentricity = 1
    max_area_variation = 0.1 # Decimal percentage only (0-whatever)
